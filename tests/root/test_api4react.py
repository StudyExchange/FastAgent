...
class Test_react_with_tool:

    def test_react_with_valid_input(self, client):
        """
        Test /react/ endpoint with valid input
        """
        messages = [{"role": "user", "content": "Hello, who are you?"}]
        response = client.post("/react/", json=messages)
        assert response.status_code == 200

    def test_react_with_invalid_input(self, client):
        """
        Test /react/ endpoint with invalid input (non-list type)
        """
    ...
    def test_react_with_empty_input(self, client):
        """
        Test /react/ endpoint with empty input list
        """
        messages = []
        response = client.post("/react/", json=messages)
        assert response.status_code == 422
    ...
    def test_react_with_llm_self_ability(self, client):
        """
        Test /react/ endpoint with llm self ability
        """
    ...
    def test_react_with_unavailable_tool(self, client):
        """
        Test /react/ endpoint with unavailable tool
        """
    ...
    def test_react_with_tool(self, client):
        """
        Test /react/ endpoint with tool
        """
    ...
    def test_react_with_tool_missing_parameters(self, client):
        """
        Test /react/ endpoint with tool missing parameters
        """
        messages = [{"role": "user", "content": "Can you help me calculate the area of a rectangle with a height of 5cm?"}]
        response = client.post("/react/", json=messages)
        assert response.status_code == 200
        assert "need" in response.text.lower() or "provide" in response.text.lower()

    def test_react_with_tool_supplementary_parameters(self, client):
        """
        Test /react/ endpoint with tool supplementary parameters
        """
        messages = [
            {
                "role": "user",
    ...
    def test_react_with_multi_tool(self, client):
        """
        Test /react/ endpoint with multi tool
        """
        messages = [
            {
                "role": "user",
    ...
    def test_react_with_multi_tool_missing_parameters(self, client):
        """
        Test /react/ endpoint with multi tool missing parameters
        """
        messages = [
            {
                "role": "user",
    ...
    def test_react_with_multi_tool_supplementary_parameters(self, client):
        """
        Test /react/ endpoint with multi tool supplementary parameters
        """
        messages = [
            {
                "role": "user",
